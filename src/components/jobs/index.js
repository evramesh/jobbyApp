...
class Jobs extends Component {
  ...
  getProfileDetails = async () => {
    this.setState({mobile: app.inProgress1})
    ...
    if (response.ok === true) {
      ...
      this.setState({profileData: newData, mobile: app.success1})
    } else {
      this.setState({mobile: app.failure1})
    }
  }
  ...
  retryAgai = () => this.getProfileDetails()
  ...
  getJobDetails = async () => {
    ...
    this.setState({appStatus: appConstants.initial})
